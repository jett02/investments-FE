                                ...
                                <form ref="form">
                                    <div class="container-fluid">
                                        ...
                                        <div class="form-group row justify-content-around py-2">
                                            ...
                                            <div class="col col-8">
                                                <input v-model="stock.symbol" type="text"
                                        ...
                                        <div class="form-group row justify-content-around py-2">
                                            ...
                                            <div class="col col-8">
                                                <input v-model="stock.name" type="text"
                                                    class="form-control-sm form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row justify-content-around py-2">
                                            ...
                                            <div class="col col-8">
                                                <input v-model="stock.shares" type="number"
                                                    class="form-control-sm form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row justify-content-around py-2">
                                            ...
                                            <div class="col col-8">
                                                <input v-model="stock.purchase_price" type="number"
                                                    class="form-control-sm form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row justify-content-around py-2">
                                            ...
                                            <div class="col col-8">
                                                <input v-model="stock.purchase_date" type="date"
                                                    class="form-control-sm form-control">
                                            </div>
                                        </div>
                                        <div class="row justify-content-around">
                                            <div v-if="!isUpdate" type="button" class="btn btn-primary col-4"
                                                @click="createStock">Save</div>
                                            <div v-if="isUpdate" type="button" class="btn btn-primary col-4"
                                                @click="updateStock">Update</div>
